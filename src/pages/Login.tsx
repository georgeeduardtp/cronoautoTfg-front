                    ...
                    <div className="flex flex-col lg:flex-row min-h-screen">
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center text-white p-4 lg:p-8">
                                ...
                                />
                                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 lg:mb-4">Bienvenido a CronoAuto</h3>
                                <p className="text-sm sm:text-base lg:text-xl opacity-90 mb-1 lg:mb-2">Accede a tu cuenta</p>
                                <p className="text-xs sm:text-sm lg:text-lg opacity-75">Gestiona tus vehículos favoritos</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-black p-12 flex flex-col justify-center lg:w-1/2">
                            <div className="max-w-md mx-auto w-full">
                                ...
                                <div className="hidden sm:block">
                                    <h2 className="text-3xl font-bold text-white">INICIA SESIÓN EN</h2>
                                    <div className="text-right -mt-1 mb-1">
                                        <p className="text-gray-300 text-sm">
                                            ¿No tienes cuenta?
                                            <a href="/registro" className="text-red-500 hover:text-red-400 underline ml-1">
                                                Regístrate
                                            </a>
                                        </p>
                                    </div>
                                ...
                                <div className="sm:hidden">
                                    <h1 className="text-2xl font-bold text-white mb-2">
                                        INICIA SESIÓN EN <span className="text-red-500">CRONOAUTO</span>
                                    </h1>
                                ...
                                <div className="hidden sm:block mb-8"></div>
                                ...
                                <form className="space-y-6">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-red-600 rounded-lg hover:bg-red-700 text-white font-medium py-4 px-6 transition-colors duration-300 text-sm tracking-wider"
                                    >
                                        INICIAR SESIÓN
                                    </button>
                                </form>
